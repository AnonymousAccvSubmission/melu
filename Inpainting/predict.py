...
parser.add_argument("--out_dir", default='./test_out/children_benchmark/', help="where to save output")
parser.add_argument("--model", type=str, default="./pretrained/generator_150_celeba.pth", help="generator model pass")
